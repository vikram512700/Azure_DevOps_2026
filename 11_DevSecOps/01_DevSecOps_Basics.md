...
2. The code fetches the secret at runtime using a Managed Identity.
3. If a secret is accidentally committed to Git, use tools like **TruffleHog** or **GitLeaks** in your pipeline to detect it and fail the build immediately.
...
2. **SAST**: Scans your code.
3. **SCA**: Scans your dependencies/libraries.
4. **Secret Scanning**: Ensures no passwords leak into Git.
...
2. You write Terraform code to create an open firewall rule (Port 22 to the world). What tool will catch this before deployment?
